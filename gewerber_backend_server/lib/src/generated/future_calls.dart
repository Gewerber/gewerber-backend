...
class _FutureCallRef {
  ...
  late final markOverdueInvoices = _MarkOverdueInvoicesFutureCallDispatcher(
    _invokeFutureCall,
  );

  late final processRecurringInvoices =
      _ProcessRecurringInvoicesFutureCallDispatcher(_invokeFutureCall);
}

class _MarkOverdueInvoicesFutureCallDispatcher {
  _MarkOverdueInvoicesFutureCallDispatcher(this._invokeFutureCall);
...
class _ProcessRecurringInvoicesFutureCallDispatcher {
  _ProcessRecurringInvoicesFutureCallDispatcher(this._invokeFutureCall);
