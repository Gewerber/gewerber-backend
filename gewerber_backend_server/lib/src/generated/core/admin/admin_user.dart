...
class AdminUserRepository {
  ...
  /// Upserts all [AdminUser]s in the list and returns the resulting rows.
  ///
  ...
  Future<List<AdminUser>> upsert(
    ...
    return session.db.upsert<AdminUser>(
      rows,
      conflictColumns: conflictColumns(AdminUser.t),
      updateColumns: updateColumns?.call(AdminUser.t),
      updateWhere: updateWhere?.call(AdminUser.t),
      transaction: transaction,
      noReturn: noReturn,
    );
  }

  /// Upserts a single [AdminUser] and returns the resulting row.
  ///
