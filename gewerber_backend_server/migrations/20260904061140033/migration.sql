...
-- ACTION ALTER TABLE
--
ALTER TABLE "reminder" ADD COLUMN "sent" boolean NOT NULL DEFAULT false;
--
-- ACTION ALTER TABLE
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('gewerber_backend', '20260904061140033', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260904061140033', "timestamp" = now();
