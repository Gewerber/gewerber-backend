...
abstract class ConflictException
  ...
  factory ConflictException.fromJson(Map<String, dynamic> jsonSerialization) {
    return ConflictException(message: jsonSerialization['message'] as String);
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      '__className__': 'ConflictException',
      'message': message,
    };
  }
...
class _ConflictExceptionImpl extends ConflictException {
  _ConflictExceptionImpl({required String message}) : super._(message: message);
