...
## Техдолг / заметки
- **⚠️ БД: recreate после мержа сквоша миграций** (PR #25): `serverpod_migrations`
  в существующих базах указывает на удалённые версии (15 миграций → одна
  `20260905122814391`); pre-launch, тестовый инстанс пересоздаётся by design.
